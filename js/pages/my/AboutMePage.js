  ...
  render() {
    let contentView = (
      <View>
        ...
        {ViewUtils.getSettingItem(
          () => this.onClick(myinfo.INDIVIDUAL),
          require("../../../res/images/ic_computer.png"),
          myinfo.INDIVIDUAL.name,
          { tintColor: "#2196F3" },
          this.getClickIcon(this.state.showIndividual)
        )}
        {this.state.showIndividual
          ? this.renderItems(myinfo.INDIVIDUAL.items, false)
          : null}
        {ViewUtils.getSettingItem(
          () => this.onClick(myinfo.REPOSITORY),
        ...
        {this.state.showContact
          ? this.renderItems(myinfo.CONTACT.items, true)
          : null}
        {ViewUtils.getSettingItem(
    ...
    return this.aboutCommon.renderView(contentView, {
      name: "GitHub Popular",
      description:
        "This is an App used to watch Github popular and trending modules, based on React-Native",
